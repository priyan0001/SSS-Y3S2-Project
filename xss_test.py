...
# setup logging
logging.basicConfig(filename='XSS_vulnerability.log' ,filemode='w', level=logging.INFO)
...
def predict_vulnerability(code):
    ...
    return prediction[0][0] > 0.9  # returns True if vulnerable, False otherwise
...
print("!!!! Scanning for the XSS vulnerabilities !!!!")
